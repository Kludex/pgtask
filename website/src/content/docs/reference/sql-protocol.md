---
title: SQL protocol
description: The database functions every client speaks, and the rules they enforce.
---
...
:::caution[A full queue rejects with PT001]
...
See [Schema compatibility](/pgtask/reference/schema-compatibility/) for how the range moves during a rollout.
