...
description: Migration rules and how to roll out a change without stopping workers.
---
...
:::caution[Never edit a migration that has reached another environment]
...
identity, so changing retries requires a new handler version. See [Retries](/pgtask/concepts/retries/).
